...
v0.5.0 已完成，项目已收口为八个主导航入口，持仓工作台成为日常操作中心。
...
- 持仓工作台内完成快速操作、计划、操作记录、复盘和持仓设置；截图重复项默认覆盖。
- 同步、GitHub 操作和备份已合并；资产配置不再是独立页面。
- 计算、支付宝解析和风险规则测试。
...
- 2026-07-01：v0.5.0 完成导航、持仓工作台、重复导入、同步备份和日报展示重构。
